export default {
  ...
  history: {
    ...
    borrowingDetail: {
      ...
      completedStatus: '已完成',
      collatRate: '抵押率',
      ltvRatioAfterAddingCollateral: '增加抵押金額後的質押率',
      collateralVGAU: '抵押品 (VGAU)',
      netAPR: '淨年化收益率',
  ...
  components: {
    ...
    productPurchase: {
      ...
      rewards: '1. 獎勵',
      rewardsDailyChange: '您申購的定期產品的年化收益率可能會每天變化。',
      rewardsStartCalculation: '獎勵將於申購次日00:00(UTC)開始計算，質押期間不可贖回。',
      rewardsAfterStaking: '質押到期後需手動轉為活期質押，對應收益將發放至賬戶，發放的收益可即可提現。',
      settlementIncome: '結算收益=已申購資產{質押VGAU數量 ×每枚VGAU的USDT(按照00:00 UTC的市值)}*年化收益率/365*定期',
      subscriptionAndRedemption: '2. 申購和贖回',
      subscriptionAndRedemptionDaily: '到期後需要由用戶在【我的理財】中手動贖回。',
      earlyRedemption: '',
      earlyRedemptionMyFinance: '不可中途贖回。',
