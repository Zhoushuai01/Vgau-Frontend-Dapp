export default {
  ...
  components: {
    ...
    increaseCollateral: {
      ...
      initialRatio: 'نسبة الضمان الأولية',
      initialCollateralRatio: 'نسبة الضمان الأولية',
      stakingRatio: 'نسبة الرهان',
      stakingRatioAfter: 'نسبة الرهان بعد الزيادة',
      stakingRatioAfterIncrease: 'نسبة الرهان بعد الزيادة',
    ...
    borrowOrder: {
      ...
      allLoaded: 'تم تحميل الكل',
      recordsFeature: 'ميزة السجلات قادمة قريباً',
      adjustPledgeRatioFeature: 'ميزة تعديل نسبة الرهان قادمة قريباً',
