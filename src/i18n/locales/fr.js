export default {
  ...
  components: {
    ...
    exchange: {
      ...
      brandDescription: 'Token d\'or numérique basé sur la blockchain',
      currency1: 'USDT',
      currency2: 'VGAU',
      exchangeAmountPlaceholder: 'Entrez le montant d\'échange',
      requiredUSDT: 'USDT Requis',
      exchanging: 'Échange en cours...',
      exchangeSuccess: 'Échange Réussi',
      exchangeSuccessDesc: 'Échange réussi de {amount} VGAU, consommé {usdt} USDT',
    ...
    redeem: {
      ...
      currency1: 'VGAU',
      currency2: 'USDT',
      redeemAmountPlaceholder: 'Entrez le montant de rachat',
      requiredUSDT: 'Obtenir USDT',
      confirmRedeem: 'Confirmer le Rachat',
      redeemSuccess: 'Rachat Réussi',
      redeemSuccessDesc: 'Rachat réussi de {amount} VGAU, obtenu {usdt} USDT',
      confirm: 'Confirmer'
    },
    ...
    productPurchase: {
      ...
      rewardsAfterStaking: 'Après l\'expiration de la période de stake, vous devez convertir manuellement en stake flexible, et les rendements correspondants seront distribués au compte. Les rendements distribués peuvent être retirés immédiatement.',
      settlementIncome: 'Rendement de règlement = Actif d\'achat {quantité de VGAU staké × valeur USDT par VGAU (selon la valeur de marché à 00:00 UTC)} × Rendement annuel ÷ 365 × Durée fixe',
      subscriptionAndRedemption: '2. Achat et Rachat',
      subscriptionAndRedemptionDaily: 'Après expiration, l\'utilisateur doit le racheter manuellement dans [Mes Finances].',
      earlyRedemption: '',
      earlyRedemptionMyFinance: 'Ne peut pas être racheté à mi-parcours.',
