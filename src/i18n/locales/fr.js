export default {
  ...
  components: {
    ...
    increaseCollateral: {
      ...
      initialRatio: 'Taux de Garantie Initial',
      initialCollateralRatio: 'Taux de Garantie Initial',
      stakingRatio: 'Taux de Stake',
    ...
    borrowOrder: {
      ...
      allLoaded: 'Tout chargé',
      recordsFeature: 'Fonctionnalité d\'enregistrements bientôt disponible',
      adjustPledgeRatioFeature: 'Fonctionnalité d\'ajustement du taux d\'engagement bientôt disponible',
