export default {
  ...
  person: {
    ...
    currentCollateral: 'Valor da Garantia Atual',
  ...
  validation: {
    ...
    code: 'Código de verificação',
    emailCodePlaceholder: 'Digite o código de verificação do email',
    totpCodePlaceholder: 'Digite o código de verificação TOTP',
    codePlaceholder: 'Digite o código de verificação'
  },

  // Modal de verificação por email
  emailVerification: {
    modal: {
      title: 'Verificação por email necessária',
      subtitle: 'Por favor, verifique seu email para completar o saque',
      methods: {
      ...
      emailCodeSent: 'Código de verificação foi enviado para seu email, verifique',
      confirm: {
  ...
  components: {
    ...
    increaseCollateral: {
      ...
      insuranceFee: 'Taxa de Seguro de Liquidação (USDT)',
      initialRatio: 'Taxa de Stake Inicial',
      initialCollateralRatio: 'Taxa de Stake Inicial',
      stakingRatio: 'Taxa de Stake Atual',
    ...
    productPurchase: {
      ...
      rewardsAfterStaking: 'Após o vencimento do período de stake, você precisa converter manualmente para stake flexível, e os rendimentos correspondentes serão distribuídos para a conta. Os rendimentos distribuídos podem ser sacados imediatamente.',
      settlementIncome: 'Rendimento de liquidação = Ativo de compra {quantidade de VGAU em stake × valor USDT por VGAU (de acordo com o valor de mercado às 00:00 UTC)} × Rendimento anual ÷ 365 × Prazo fixo',
      subscriptionAndRedemption: '2. Compra e Resgate',
      subscriptionAndRedemptionDaily: 'Após o vencimento, o usuário precisa resgatar manualmente em [Minhas Finanças].',
      earlyRedemption: '',
      earlyRedemptionMyFinance: 'Não pode ser resgatado no meio do caminho.',
      earlyRedemptionLoseIncome: '',
      earlyRedemptionBalanceCredit: '',
      earlyRedemptionMarketFluctuations: '',
      confirm: 'Confirmar',
      processing: 'Processando...',
    ...
    borrowOrder: {
      ...
      netAnnualizedInterestRate: 'USDT a Pagar',
      liquidationReferencePrice: 'Preço de Referência de Liquidação (VGAU/USDT)',
      increaseCollateralAmount: 'Aumentar Valor da Garantia',
      adjustPledgeRatio: 'Ajustar Taxa de Empenho',
      fullRepayment: 'Pagamento Total',
      allLoaded: 'Tudo carregado',
      recordsFeature: 'Funcionalidade de registros em breve',
      adjustPledgeRatioFeature: 'Funcionalidade de pagamento total em breve',
