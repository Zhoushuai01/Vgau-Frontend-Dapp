export default {
  ...
  // نافذة التحقق عبر البريد الإلكتروني
  emailVerification: {
    modal: {
      title: 'التحقق عبر البريد الإلكتروني مطلوب',
      subtitle: 'يرجى التحقق من بريدك الإلكتروني لإكمال السحب',
      methods: {
  ...
  components: {
    ...
    productPurchase: {
      ...
      settlementIncome: 'عائد التسوية = أصل الشراء {كمية VGAU المرهونة × قيمة USDT لكل VGAU (حسب القيمة السوقية في 00:00 UTC)} × العائد السنوي ÷ 365 × المدة الثابتة',
      subscriptionAndRedemption: '2. الشراء والاسترداد',
      subscriptionAndRedemptionDaily: 'بعد انتهاء المدة، يحتاج المستخدم إلى الاسترداد يدوياً في [تمويلي].',
      earlyRedemption: '',
      earlyRedemptionMyFinance: 'لا يمكن الاسترداد في منتصف المدة.',
