export default {
  ...
  components: {
    ...
    increaseCollateral: {
      ...
      insuranceFee: 'Liquidation Insurance Fee(USDT)',
      initialRatio: 'Initial Staking Ratio',
      initialCollateralRatio: 'Initial Staking Ratio',
      stakingRatio: 'Current Staking Ratio',
    ...
    productPurchase: {
      ...
      rewardsStartCalculation: 'Rewards will start calculating at 00:00 (UTC) on the day after subscription, and cannot be redeemed during the staking period.',
      rewardsAfterStaking: 'After the staking period expires, it needs to be manually converted to flexible staking, and the corresponding income will be distributed to the account. The distributed income can be withdrawn immediately.',
      settlementIncome: 'Settlement income = subscribed assets {quantity of staked VGAU × USDT value per VGAU (according to the market value at 00:00 UTC)} * annualized yield / 365 * fixed term',
      subscriptionAndRedemption: '2. Subscription and Redemption',
      subscriptionAndRedemptionDaily: 'After expiration, the user needs to manually redeem it in [My Finances].',
      earlyRedemption: '',
      earlyRedemptionMyFinance: 'Cannot be redeemed midway.',
